...
public class CalculatorServiceImpl implements CalculatorService{
    ...
    public HomeResponseDto getHomeInformation(HomeDto home) throws DistrictNotFoundException {
    ...
    public double getPrice(HomeDto home) throws DistrictNotFoundException {
        District district = null;

        try{
            district = District.valueOf(home.getPropDistrict().toUpperCase(Locale.ROOT));
        } catch (IllegalArgumentException ex) {
            throw new DistrictNotFoundException("District not found or does not exist");
        }
